...
type CreateRequestDto struct {
	...
	Product  admin_product_handler.CreateRequestDto `json:"product"`
}
...
type CreateResponseDto struct {
	...
	EndAt     *time.Time                                 `json:"endAt" example:"2024-01-10T00:00:00Z"`
	StartAt   *time.Time                                 `json:"startAt" example:"2024-01-01T00:00:00Z"`
	Product   admin_product_handler.CreateResponseDto `json:"product"`
}
...
type UpdateRequestDto struct {
	...
	State    *string                                   `json:"state" example:"FL"`
	Location *string                                   `json:"location" example:"Disney"`
	Product  admin_product_handler.UpdateRequestDto `json:"product"`
}
...
type GetOneByIdProductDto struct {
	...
	Installments   admin_product_handler.InstallmentsResponseDto `json:"installments"`
}
