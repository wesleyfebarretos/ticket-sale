...
func HandleAdminGateway(router *gin.RouterGroup) {
	...
	adminGateway.POST("", admin_gateway_handler.Create)
	adminGateway.GET("", admin_gateway_handler.GetAll)
	adminGateway.GET(":id", admin_gateway_handler.GetOneById)
	adminGateway.PUT(":id", admin_gateway_handler.Update)
	adminGateway.DELETE(":id", admin_gateway_handler.SoftDelete)
}
