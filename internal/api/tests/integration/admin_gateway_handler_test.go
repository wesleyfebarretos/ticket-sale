...
func TestAdminGatewayHandler(t *testing.T) {
	t.Run("it should create a gateway", TRun(func(t *testing.T) {
		...
		newGateway := admin_gateway_handler.CreateReqDTO{
			Name:              "Testing",
		...
		gatewayResponse := admin_gateway_handler.CreateResDTO{}
	...
	t.Run("it should update a gateway", TRun(func(t *testing.T) {
		...
		updateParams := admin_gateway_handler.UpdateReqDTO{
	...
	t.Run("it should get all gateways", TRun(func(t *testing.T) {
		...
		getAllResponse := []admin_gateway_handler.GetAllResDTO{}

		test_utils.Decode(t, res.Body, &getAllResponse)

		assert.Equal(t, http.StatusOK, res.StatusCode)
		assert.Equal(t, 1, len(getAllResponse))
		assert.IsType(t, admin_gateway_handler.GetAllResDTO{}, getAllResponse[0])
	}))
	...
	t.Run("it should get gateway by id", TRun(func(t *testing.T) {
		...
		getOneByIdResponse := admin_gateway_handler.GetOneByIdResDTO{}
